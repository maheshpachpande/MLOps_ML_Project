...
from us_visa.utils import save_object, save_numpy_array_data, read_yaml_file, drop_columns
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                TARGET_COLUMN = config['files']['target_column']
                ...
                input_feature_train_df['company_age'] = config['files']['current_year']-input_feature_train_df['yr_of_estab']
                ...
                input_feature_test_df['company_age'] = config['files']['current_year']-input_feature_test_df['yr_of_estab']
