...
from us_visa.utils import load_numpy_array_data, read_yaml_file, load_object, save_object
...
if __name__ == "__main__":
    try:
        ...
        # Mocked artifact paths (you should read them from YAML or pipeline orchestration logic)
        ...
        logging.info(f"Evaluation metrics: {model_trainer_artifact.metric_artifact}")

    except Exception as e:
        logging.exception("Exception occurred in Model Trainer Component.")
        raise USvisaException(e, sys) from e
